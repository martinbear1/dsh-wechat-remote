# Agent resources v1 protocol

Release boundary: the plugin implementation described here is included in **1.7.2**. A plugin release does not publish the companion mini-program UI or certify every DSH/platform combination.
