window.__ModuleLoader__.load({id:"@harness-remote/dsh-wechat-remote",factory:(require)=>{var module={exports:{}};var exports=module.exports;"use strict";var F=Object.create;var b=Object.defineProperty;var W=Object.getOwnPropertyDescriptor;var T=Object.getOwnPropertyNames;var K=Object.getPrototypeOf,V=Object.prototype.hasOwnProperty;var Y=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Z=(t,e)=>{for(var a in e)b(t,a,{get:e[a],enumerable:!0})},z=(t,e,a,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let d of T(e))!V.call(t,d)&&d!==a&&b(t,d,{get:()=>e[d],enumerable:!(o=W(e,d))||o.enumerable});return t};var nn=(t,e,a)=>(a=t!=null?F(K(t)):{},z(e||!t||!t.__esModule?b(a,"default",{value:t,enumerable:!0}):a,t)),en=t=>z(b({},"__esModule",{value:!0}),t);var E=Y((dn,I)=>{"use strict";var tn=`.hr_cd758f9_root {
...
`,B="@harness-remote/dsh-wechat-remote/HarnessRemoteSettings.module.css";if(typeof document<"u"&&document.querySelector("style[data-plugin-css="+JSON.stringify(B)+"]")===null){let t=document.createElement("style");t.dataset.plugin="@harness-remote/dsh-wechat-remote",t.dataset.pluginCss=B,t.textContent=tn,document.head.appendChild(t)}I.exports={root:"hr_cd758f9_root",hero:"hr_cd758f9_hero",connectCard:"hr_cd758f9_connectCard",pairingCard:"hr_cd758f9_pairingCard",identity:"hr_cd758f9_identity",mark:"hr_cd758f9_mark",identityCopy:"hr_cd758f9_identityCopy",pairingHead:"hr_cd758f9_pairingHead",securityNote:"hr_cd758f9_securityNote",overall:"hr_cd758f9_overall",statusDot:"hr_cd758f9_statusDot",capabilities:"hr_cd758f9_capabilities",capability:"hr_cd758f9_capability",capabilityCopy:"hr_cd758f9_capabilityCopy",notice:"hr_cd758f9_notice",secondaryButton:"hr_cd758f9_secondaryButton",primaryButton:"hr_cd758f9_primaryButton",qrArea:"hr_cd758f9_qrArea",qr:"hr_cd758f9_qr",qrPlaceholder:"hr_cd758f9_qrPlaceholder",qrMeta:"hr_cd758f9_qrMeta"}});var on={};Z(on,{apply:()=>rn,inject:()=>an});module.exports=en(on);var s=require("react"),A=require("@deepseek-ai/dsh-client-ui-primitives"),r=nn(E(),1),n=require("react/jsx-runtime"),G="http://127.0.0.1:3093";function L({ok:t,busy:e=!1}){return(0,n.jsx)("span",{className:r.default.statusDot,"data-state":e?"busy":t?"ready":"off","aria-hidden":!0})}function v({title:t,detail:e,ok:a,busy:o=!1}){return(0,n.jsxs)("div",{className:r.default.capability,children:[(0,n.jsx)(L,{ok:a,busy:o}),(0,n.jsxs)("div",{className:r.default.capabilityCopy,children:[(0,n.jsx)("strong",{children:t}),(0,n.jsx)("span",{children:e})]})]})}async function j(t){try{let e=await t(),a=e.gate;return!a||!Number.isSafeInteger(a.localDoor.port)?{origin:G,runtime:null,host:e}:{origin:`http://127.0.0.1:${a.localDoor.port}`,runtime:a,host:e}}catch{return{origin:G,runtime:null,host:null}}}function M({describeHost:t}){let[e,a]=(0,s.useState)("loading"),[o,d]=(0,s.useState)("idle"),[p,w]=(0,s.useState)(null),[$,m]=(0,s.useState)(null),[C,R]=(0,s.useState)(null),[f,H]=(0,s.useState)(null),[N,g]=(0,s.useState)(null),l=(0,s.useRef)(!0),y=(0,s.useCallback)(async()=>{try{let i=await j(t);if(!l.current)return;if(m(i.runtime),R(i.host),i.runtime!==null&&i.runtime.localDoor.state!=="listening")throw new Error("local-door-unavailable");let c=await fetch(`${i.origin}/gate/status`);if(!c.ok)throw new Error(`gate/status ${c.status}`);let h=await c.json();if(!l.current)return;w(h),m(h.gate??i.runtime),a("ready"),g(null)}catch{if(!l.current)return;a("error"),g("连接服务暂未就绪。请确认 DSH 正在运行，然后重试。")}},[t]),k=(0,s.useCallback)(async()=>{d("loading"),g(null);try{let i=await j(t);if(!l.current)return;if(m(i.runtime),R(i.host),i.runtime!==null&&i.runtime.localDoor.state!=="listening")throw new Error("local-door-unavailable");let[c,h]=await Promise.all([fetch(`${i.origin}/pair/code`),fetch(`${i.origin}/gate/status`)]);if(!c.ok)throw new Error(`pair/code ${c.status}`);let X=await c.json();if(!l.current)return;if(H(X),d("ready"),h.ok){let P=await h.json();w(P),m(P.gate??i.runtime),a("ready")}}catch{if(!l.current)return;H(null),d("error"),g("暂时无法生成配对码，请稍后重试。")}},[t]);(0,s.useEffect)(()=>{l.current=!0,y();let i=window.setInterval(()=>void y(),3e4);return()=>{l.current=!1,window.clearInterval(i)}},[y]);let _=p?.publicRelay,D=_?.state==="enrolling"||_?.state==="connecting",u=_?.remoteAccess?.status,x=_?.state==="online"&&u==="active",Q=u==="suspended"?"账户公网访问已暂停":u==="pending"?"体验申请审核中":u==="expired"?"公网访问已到期":u==="not_entitled"?"请在小程序中申请体验":u!=="active"?"配对后由小程序账户决定":x?"可在外网安全连接":D?"正在准备远程连接":"暂时离线",J=$?.localDoor??p?.gate?.localDoor,S=e==="ready"&&!!p?.lan.ip&&J?.state==="listening",q=x||p?.wechat.configured===!0,O=p?.agent?.agentName||C?.agentName||"DeepSeek Harness",U=p?.agent?.hostName||C?.computerName||"当前电脑";return(0,n.jsxs)("section",{className:r.default.root,"aria-labelledby":"harness-remote-title",children:[(0,n.jsxs)("div",{className:r.default.hero,children:[(0,n.jsxs)("div",{className:r.default.identity,children:[(0,n.jsx)("span",{className:r.default.mark,"aria-hidden":!0,children:(0,n.jsx)(A.FishLogo,{size:28})}),(0,n.jsxs)("div",{className:r.default.identityCopy,children:[(0,n.jsx)("h3",{id:"harness-remote-title",children:"鲸常在"}),(0,n.jsxs)("p",{children:[O,(0,n.jsx)("span",{"aria-hidden":!0,children:" · "}),U]})]})]}),(0,n.jsxs)("span",{className:r.default.overall,"data-ready":e==="ready",children:[(0,n.jsx)(L,{ok:e==="ready",busy:e==="loading"}),e==="loading"?"检测中":e==="ready"?"服务正常":"暂不可用"]})]}),(0,n.jsxs)("div",{className:r.default.capabilities,children:[(0,n.jsx)(v,{title:"局域网直连",detail:e==="loading"?"检测中":S?"已就绪":"暂不可用",ok:S,busy:e==="loading"}),(0,n.jsx)(v,{title:"远程访问",detail:Q,ok:x,busy:D||e==="loading"}),(0,n.jsx)(v,{title:"微信账号保护",detail:q?"已启用":"配对后启用",ok:q,busy:e==="loading"})]}),N!==null?(0,n.jsxs)("div",{className:r.default.notice,role:"status",children:[(0,n.jsx)("span",{children:N}),(0,n.jsx)("button",{type:"button",onClick:()=>void y(),children:"重试"})]}):null,o==="idle"?(0,n.jsxs)("div",{className:r.default.connectCard,children:[(0,n.jsxs)("div",{children:[(0,n.jsx)("strong",{children:"添加到微信"}),(0,n.jsx)("p",{children:"打开「鲸常在」→ 添加节点，扫描配对码。"})]}),(0,n.jsx)("button",{type:"button",className:r.default.primaryButton,onClick:()=>void k(),children:"生成配对码"})]}):(0,n.jsxs)("div",{className:r.default.pairingCard,children:[(0,n.jsxs)("div",{className:r.default.pairingHead,children:[(0,n.jsxs)("div",{children:[(0,n.jsx)("strong",{children:"扫描二维码"}),(0,n.jsx)("p",{children:"小程序「设置 → 添加节点」"})]}),(0,n.jsx)("button",{type:"button",className:r.default.secondaryButton,disabled:o==="loading",onClick:()=>void k(),children:o==="loading"?"生成中…":"重新生成"})]}),(0,n.jsxs)("div",{className:r.default.qrArea,children:[o==="ready"&&f!==null?(0,n.jsx)("img",{className:r.default.qr,src:f.qrDataUrl,alt:"鲸常在配对二维码"}):(0,n.jsx)("div",{className:r.default.qrPlaceholder,"aria-live":"polite",children:o==="error"?"生成失败":"正在生成…"}),o==="ready"&&f!==null?(0,n.jsxs)("div",{className:r.default.qrMeta,children:[(0,n.jsx)("span",{children:"配对码"}),(0,n.jsx)("code",{children:f.code}),(0,n.jsx)("small",{children:"15 分钟内有效"})]}):null]}),(0,n.jsx)("p",{className:r.default.securityNote,children:f?.mode==="public-relay"?"配对后自动选择更快的连接；远程内容端到端加密。":"当前可通过同一局域网连接。"})]})]})}var an=["slots","connection"];function rn(t){let e=async()=>{let a=await t.connection.rpc.call("/api","wechatHost/describe",{args:{request:{}}});if(!a.ok)throw new Error(`wechatHost/describe: ${a.error.code}`);let o=a.value;if(o?.ok!==!0||o.value===void 0)throw new Error("wechatHost/describe returned an invalid result");return o.value};t.slots.inject("settings.section",()=>t.slots.register({name:"settings.section",id:"harness-remote",order:30,label:"微信连接",inject:()=>({describeHost:e})},M))}
