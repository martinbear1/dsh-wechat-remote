...
export class PublicObjectClient {
    ...
    async download(objectId, expectedMaximum = 20 * 1024 * 1024 + 4096) {
        ...
        const ticket = await this.requestJson('GET', pathname);
    ...
    async upload(purpose, body) {
        ...
        return this.requestJson('POST', completePath, {});
    }
