...
export class TurnActivityCompatibility {
    ...
    accept(event) {
        ...
        if (event.type === 'turn/start')
            this.state = { turn: d.turn, start: seq, calls: new Map(), results: new Set(), changes: [], messages: [], visible: [], contexts: [], humans: [], tools: [], subagents: [], answer: null, reasoning: false, step: null };
        const s = this.state;
        if (!s)
            return;
